        ...
        <div className="flex items-center justify-between">
            ...
            {links.map((link) => {
              ...
              return (
                <Link
                  ...
                  className={`relative whitespace-nowrap px-4 py-2.5 text-sm font-semibold rounded-full transition-colors duration-200 ${
                    isActive
          ...
          <div className="hidden xl:flex items-center">
            <a
              ...
              className="whitespace-nowrap px-6 py-2.5 gradient-bg text-white hover:shadow-lg hover:shadow-blue-500/30 rounded-full font-bold text-sm flex items-center gap-2 hover:-translate-y-0.5 transition-all duration-300"
            >
          ...
          <button
            ...
            className="xl:hidden p-2.5 text-slate-700 hover:text-blue-600 bg-slate-50 hover:bg-slate-100 rounded-full transition-colors"
